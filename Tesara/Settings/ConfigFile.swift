...
enum ConfigFile {
    ...
    static func buildConfigString(from settings: AppSettings) -> String {
        ...
        lines.append("\(K.cursorBarWidth) = \(fmt(settings.cursorBarWidth))")
        lines.append("\(K.cursorRounded) = \(settings.cursorRounded)")
        lines.append("\(K.cursorBlink) = \(settings.cursorBlink)")
        lines.append("\(K.cursorGlow) = \(settings.cursorGlow)")
        lines.append("\(K.cursorGlowRadius) = \(fmt(settings.cursorGlowRadius))")
        lines.append("\(K.cursorGlowOpacity) = \(fmt(settings.cursorGlowOpacity))")
        lines.append("\(K.cursorSmoothBlink) = \(settings.cursorSmoothBlink)")
        lines.append("")
        lines.append("# Window")
    ...
    static func applyParsedConfig(_ parsed: [String: [String]], to settings: inout AppSettings) {
        ...
        settings.cursorBarWidth = double(K.cursorBarWidth, d.cursorBarWidth)
        settings.cursorRounded = bool(K.cursorRounded, d.cursorRounded)
        settings.cursorBlink = bool(K.cursorBlink, d.cursorBlink)
        settings.cursorGlow = bool(K.cursorGlow, d.cursorGlow)
        settings.cursorGlowRadius = double(K.cursorGlowRadius, d.cursorGlowRadius)
        settings.cursorGlowOpacity = double(K.cursorGlowOpacity, d.cursorGlowOpacity)
        settings.cursorSmoothBlink = bool(K.cursorSmoothBlink, d.cursorSmoothBlink)
